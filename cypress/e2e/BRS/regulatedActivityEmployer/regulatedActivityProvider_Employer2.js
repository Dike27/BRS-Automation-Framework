...
import WhatIsYourNamePageNew from "../../../../page-objects/your-details/WhatIsYourNamePageNew";
...
const whatIsYourNamePageNew = new WhatIsYourNamePageNew()
...
describe("Local Authority or Government Referral", () => {
  ...
  it("Complete a Referrer's Detail Questionnaire", () => {
    //referredPersonDetailsPage.referrerDetails
    ...
    //Complete a Referred person's details Questionnaire
    //cy.contains('Referred person\'s details').click()
