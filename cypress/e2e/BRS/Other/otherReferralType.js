...
import other_start_page_PO from "../../../support/pageObjects/BRS/StartPages/7. other-start-page_PO";
...
describe("Complete a Other Referral", () => {
  const otherStartPage = new other_start_page_PO();
  ...
  it("Complete and submit a Keeper of register or supervisory authority referral questionnaire", () => {
    otherStartPage.getOtherStartPageDetails();
